...
export default function contactanos() {
    ...
    return (  
                ...
                <div className="row " id="contenedor-productos">
                    ...
                    <div className="card col-12 col-sm-6 col-lg-4 mbottom-6"  >
                        ...
                        <div className="card-body d-flex justify-content-center">
                            <button type="button" className="btn btn-dark btn-agregar-al-carrito" id="1" >AÑADIR AL CARRITO</button>
                        </div>
        ...
        <div className="d-flex justify-content-center">
            <button id="ver-mas"  type="button" className="btn btn-agregar-al-carrito" >VER MÁS</button>
        </div>
    </div>
