    ...
    <div>
      ...
      <Carousel style={{ width: '40%' }}>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h3 style={{ color: '#187ac9'  , fontSize: '50px' }}>Pediatría</h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <ImagenesCarrusel src="/images/20006.JPG"  alt="Pediatria" />
          <Carousel.Caption>
            <h3 style={{ color: '#187ac9' , fontSize: '50px'}}>Dermatología</h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <ImagenesCarrusel src="/images/20005.JPG"  alt="Cardiologia" />
          <Carousel.Caption>
            <h3 style={{ color: '#187ac9' , fontSize: '50px' }}>Cardiología</h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <ImagenesCarrusel src="/images/20009.JPG"alt="Oftalmologia" />
          <Carousel.Caption>
            <h3 style={{ color: '#187ac9' , fontSize: '50px' }}>Oftamología</h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <ImagenesCarrusel src="/images/2010.jpg"  alt="Quiropractico" />
          <Carousel.Caption>
            <h3 style={{ color: '#187ac9', fontSize: '50px' }}>Quiropráctico</h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <ImagenesCarrusel src="/images/20002.JPG"  alt="Psicologia" />
          <Carousel.Caption>
            <h3 style={{color: '#187ac9' , fontSize: '50px' }}>Psicología</h3>
          </Carousel.Caption>
        </Carousel.Item>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h3 style={{ color: '#187ac9' , fontSize: '50px' }}>Ortopedia</h3>
          </Carousel.Caption>
        </Carousel.Item>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h3 style={{ color: '#187ac9' , fontSize: '50px'}}>Medicina General</h3>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
      </div>
